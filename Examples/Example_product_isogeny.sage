...
Pr = 3^7*E0.random_element()
E1 = E0.isogeny(Pr).codomain()
Q,_ = E1.torsion_basis(17)
#Q = E1.lift_x(3349)
#assert Q.order() == 17
phi = E1.isogeny(Q)
E2 = phi.codomain()
...
if P0_3.weil_pairing(Q0_3,3) != omega^2:
	Q0 = 2*Q0
...
P2 = 8*Q0
Q2 = 8*P0
# kernel will be generated by (P1,Q2) , (P2,Q1)
...
Phi = compute_isogeny_chain((R,S), (R_9,S_9), 4, (a,b,c), auxP=auxP);

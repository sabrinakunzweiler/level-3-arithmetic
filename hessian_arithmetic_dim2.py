...
class AbelianSurfaceHessianForm(AlgebraicScheme_subscheme_projective):
    ...
    def __init__(self, d, h, omega=None):
        r"""
...
class HessianEvenKummerSurface(SageObject):
    ...
    def __init__(self, hessian_surface):
        ...
        P4 = ProjectiveSpace(self._base_ring, names="U0,U1,U2,U3,U4")
    ...
    def __call__(self, coords):
        ...
        """
        return HessianEvenKummerSurfacePoint(self, coords)
...
class HessianOddKummerSurface(SageObject):
    ...
    def __init__(self, hessian_surface):
        ...
        P3 = ProjectiveSpace(self._base_ring, names='V0,V1,V2,V3')
